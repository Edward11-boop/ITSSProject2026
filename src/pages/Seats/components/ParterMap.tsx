    ...
    return (
        <div className="relative mx-auto h-[650px] w-full max-w-[1000px] border border-gray-800 bg-[#F5F3FF] overflow-hidden shadow-sm">
            ...
            <div className="absolute left-6 top-6">
                ...
                <SingleSeat selectedSeat={getSelectedState("P-SD0-01")} onSelect={handleSeatSelection} id="P-SD0-01" number="1" status="available" className="top-[50px] left-[30px]" />
                <SingleSeat selectedSeat={getSelectedState("P-SD0-02")} onSelect={handleSeatSelection} id="P-SD0-02" number="2" status="available" className="top-[50px] left-[100px]" />
                <SingleSeat selectedSeat={getSelectedState("P-SD0-03")} onSelect={handleSeatSelection} id="P-SD0-03" number="3" status="available" className="top-[145px] left-[30px]" />
                <SingleSeat selectedSeat={getSelectedState("P-SD0-04")} onSelect={handleSeatSelection} id="P-SD0-04" number="4" status="occupied" className="top-[145px] left-[100px]" />
                <div className="absolute top-[225px] left-[10px] h-[50px] w-[150px] border border-[#7C7777] bg-[#C1BDD2]"></div>
                <SingleSeat selectedSeat={getSelectedState("P-SD0-05")} onSelect={handleSeatSelection} id="P-SD0-05" number="5" status="occupied" className="top-[190px] left-[30px]" />
                <SingleSeat selectedSeat={getSelectedState("P-SD0-06")} onSelect={handleSeatSelection} id="P-SD0-06" number="6" status="available" className="top-[190px] left-[100px]" />
                <SingleSeat selectedSeat={getSelectedState("P-SD0-07")} onSelect={handleSeatSelection} id="P-SD0-07" number="7" status="occupied" className="top-[285px] left-[30px]" />
                <SingleSeat selectedSeat={getSelectedState("P-SD0-08")} onSelect={handleSeatSelection} id="P-SD0-08" number="8" status="occupied" className="top-[285px] left-[100px]" />
            </div>
            ...
            <div className="absolute top-0 right-0 w-[350px] h-[250px] p-4">
                ...
                <SingleSeat selectedSeat={getSelectedState("P-S0-01")} onSelect={handleSeatSelection} id="P-S0-01" number="1" status="available" type="room" className="top-[35px] left-[80px]" />
                <SingleSeat selectedSeat={getSelectedState("P-S0-02")} onSelect={handleSeatSelection} id="P-S0-02" number="2" status="available" type="room" className="top-[35px] left-[125px]" />
                <SingleSeat selectedSeat={getSelectedState("P-S0-03")} onSelect={handleSeatSelection} id="P-S0-03" number="3" status="available" type="room" className="top-[35px] left-[170px]" />
                <SingleSeat selectedSeat={getSelectedState("P-S0-04")} onSelect={handleSeatSelection} id="P-S0-04" number="4" status="available" type="room" className="top-[65px] left-[280px]" />
                <SingleSeat selectedSeat={getSelectedState("P-S0-05")} onSelect={handleSeatSelection} id="P-S0-05" number="5" status="available" type="room" className="top-[110px] left-[280px]" />
                <SingleSeat selectedSeat={getSelectedState("P-S0-06")} onSelect={handleSeatSelection} id="P-S0-06" number="6" status="available" type="room" className="top-[155px] left-[280px]" />
                <SingleSeat selectedSeat={getSelectedState("P-S0-08")} onSelect={handleSeatSelection} id="P-S0-08" number="8" status="available" type="room" className="top-[140px] left-[110px]" />
                <SingleSeat selectedSeat={getSelectedState("P-S0-07")} onSelect={handleSeatSelection} id="P-S0-07" number="7" status="available" type="room" className="top-[140px] left-[160px]" />
            </div>
            ...
            <div className="absolute top-[250px] right-0 w-[350px] h-[280px]">
                ...
                <SingleSeat selectedSeat={getSelectedState("P-B0-03")} onSelect={handleSeatSelection} id="P-B0-03" number="3" status="available" className="top-[95px] left-[20px]" />
                <SingleSeat selectedSeat={getSelectedState("P-B0-04")} onSelect={handleSeatSelection} id="P-B0-04" number="4" status="occupied" className="top-[130px] left-[20px]" />
                <SingleSeat selectedSeat={getSelectedState("P-B0-05")} onSelect={handleSeatSelection} id="P-B0-05" number="5" status="available" className="top-[165px] left-[20px]" />
                <SingleSeat selectedSeat={getSelectedState("P-B0-06")} onSelect={handleSeatSelection} id="P-B0-06" number="6" status="occupied" className="top-[200px] left-[20px]" />
                <div className="absolute top-[20px] left-[165px] h-[240px] w-[35px] border border-[#7C7777] bg-[#C1BDD2]"></div>
                <SingleSeat selectedSeat={getSelectedState("P-B0-07")} onSelect={handleSeatSelection} id="P-B0-07" number="7" status="available" className="top-[25px] left-[215px]" />
                <SingleSeat selectedSeat={getSelectedState("P-B0-08")} onSelect={handleSeatSelection} id="P-B0-08" number="8" status="occupied" className="top-[60px] left-[215px]" />
                <SingleSeat selectedSeat={getSelectedState("P-B0-09")} onSelect={handleSeatSelection} id="P-B0-09" number="9" status="occupied" className="top-[95px] left-[215px]" />
                <SingleSeat selectedSeat={getSelectedState("P-B0-10")} onSelect={handleSeatSelection} id="P-B0-10" number="10" status="available" className="top-[130px] left-[215px]" />
                <SingleSeat selectedSeat={getSelectedState("P-B0-11")} onSelect={handleSeatSelection} id="P-B0-11" number="11" status="available" className="top-[165px] left-[215px]" />
                <SingleSeat selectedSeat={getSelectedState("P-B0-12")} onSelect={handleSeatSelection} id="P-B0-12" number="12" status="available" className="top-[200px] left-[215px]" />
            </div>
